...
# instance fields
.field public final mJsSegmentFetcher:LX/LNT;


# direct methods
.method public constructor <init>(LX/JDh;LX/LNT;)V
    .locals 0

    .line 0
    invoke-direct {p0, p1}, Lcom/facebook/fbreact/specs/NativeSegmentFetcherSpec;-><init>(LX/JDh;)V

    .line 1
    .line 2
    .line 3
    iput-object p2, p0, Lcom/facebook/common/downloadondemand/metadataless/client/js/interfaces/JsSegmentFetcherModule;->mJsSegmentFetcher:LX/LNT;
...
.method public static synthetic access$100(Ljava/lang/Throwable;)LX/LUo;
    .locals 0

    .line 0
    invoke-static {p0}, Lcom/facebook/common/downloadondemand/metadataless/client/js/interfaces/JsSegmentFetcherModule;->createJsErrorObject(Ljava/lang/Throwable;)LX/LUo;
...
.method public static createJsErrorObject(Ljava/lang/Throwable;)LX/LUo;
    .locals 3
...
.method private fetchSegmentInternal(DLX/LUo;LX/LSC;)V
    .locals 14
    ...
    .line 14
    iget-object v5, p0, Lcom/facebook/common/downloadondemand/metadataless/client/js/interfaces/JsSegmentFetcherModule;->mJsSegmentFetcher:LX/LNT;
    ...
    .line 18
    .line 19
    invoke-direct {v6, v2, v1, v0}, LX/K7Z;-><init>(Ljava/lang/String;Ljava/lang/String;I)V

    .line 20
    .line 21
    .line 22
    check-cast v5, LX/KfZ;
    ...
    .line 29
    .line 30
    iget-object v0, v5, LX/KfZ;->A01:Lcom/facebook/quicklog/QuickPerformanceLogger;
    ...
    .line 33
    .line 34
    invoke-direct {v3, v6, v0}, LX/JwL;-><init>(LX/K7Z;Lcom/facebook/quicklog/QuickPerformanceLogger;)V

    .line 35
    .line 36
    .line 37
    iget-object v2, v5, LX/KfZ;->A00:LX/19i;

    .line 38
    .line 39
    iget v1, v6, LX/K7Z;->A00:I
    ...
    .line 48
    .line 49
    iget-object v0, v2, LX/19i;->A06:LX/19K;

    .line 50
    .line 51
    invoke-virtual {v0}, LX/19K;->A00()I
    ...
    .line 62
    .line 63
    iget-object v0, v6, LX/K7Z;->A02:Ljava/lang/String;
    ...
    .line 68
    :cond_0
    iget-object v7, v3, LX/JwL;->A01:LX/K7Z;

    .line 69
    .line 70
    iget-object v0, v3, LX/JwL;->A00:LX/JwK;

    .line 71
    .line 72
    iget-object v6, v0, LX/JwK;->A01:LX/0We;
    ...
    .line 76
    .line 77
    iget v0, v0, LX/JwK;->A00:I

    .line 78
    .line 79
    invoke-interface {v6, v1, v0}, LX/0We;->markerStart(II)V

    .line 80
    .line 81
    .line 82
    invoke-interface {v6, v1, v0}, LX/0We;->withMarker(II)Lcom/facebook/quicklog/MarkerEditor;
    ...
    .line 109
    .line 110
    iget-object v1, v7, LX/K7Z;->A01:Ljava/lang/String;
    ...
    .line 126
    .line 127
    iget-object v1, v5, LX/KfZ;->A02:Ljava/util/concurrent/ExecutorService;

    .line 128
    .line 129
    invoke-virtual {v2, v8}, LX/19i;->A01(LX/K7z;)LX/Jyo;
    ...
    .line 141
    .line 142
    invoke-direct {v1, v3, v4}, LX/Kss;-><init>(LX/JwL;LX/LSC;)V
    ...
    .line 151
    :cond_2
    invoke-static {v2, v8, v1}, LX/19i;->A00(LX/19i;LX/K7z;Ljava/util/concurrent/Executor;)Lcom/google/common/util/concurrent/ListenableFuture;
...
.method public static getModuleName(LX/LUo;)Ljava/lang/String;
    .locals 1
    ...
    .line 1
    .line 2
    invoke-interface {p0, v0}, LX/LUo;->getString(Ljava/lang/String;)Ljava/lang/String;
...
.method public static getSegmentHash(LX/LUo;)Ljava/lang/String;
    .locals 1
...
# virtual methods
.method public fetchSegment(DLX/LUo;Lcom/facebook/react/bridge/Callback;)V
    .locals 2
    ...
    .line 2
    .line 3
    invoke-direct {v0, p0, p4, v1}, LX/Kfb;-><init>(Lcom/facebook/common/downloadondemand/metadataless/client/js/interfaces/JsSegmentFetcherModule;Lcom/facebook/react/bridge/Callback;I)V

    .line 4
    .line 5
    .line 6
    invoke-direct {p0, p1, p2, p3, v0}, Lcom/facebook/common/downloadondemand/metadataless/client/js/interfaces/JsSegmentFetcherModule;->fetchSegmentInternal(DLX/LUo;LX/LSC;)V
...
.method public getSegment(DLX/LUo;Lcom/facebook/react/bridge/Callback;)V
    .locals 1
    ...
    .line 1
    .line 2
    invoke-direct {v0, p4}, LX/Kfa;-><init>(Lcom/facebook/react/bridge/Callback;)V
