...
.method public static final getSleepPerChunkOverride(LX/0hc;)J
    .locals 1
    ...
    .line 5
    .line 6
    invoke-direct {v0, p0}, Lcom/instagram/debug/network/DebugNetworkShapingServerOverrideHelper;->isDayEnabled(LX/0hc;)Z
    ...
    .line 15
    :cond_0
    invoke-static {p0}, Lcom/instagram/debug/network/L$ig_android_slow_network_debug_tool_config$sleep_time_per_chunk;->getAndExpose(LX/0hc;)Ljava/lang/Long;
...
.method private final isDayEnabled(LX/0hc;)Z
    .locals 3

    .line 0
    invoke-static {p1}, Lcom/instagram/debug/network/L$ig_android_slow_network_debug_tool_config$days_of_week;->getAndExpose(LX/0hc;)Ljava/lang/Long;
