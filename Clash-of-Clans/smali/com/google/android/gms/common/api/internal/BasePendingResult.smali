...
# instance fields
.field private mResultGuardian:Lb2/n1;
    .annotation build Lcom/google/android/gms/common/annotation/KeepName;
    .end annotation
...
.field private volatile zap:Lb2/b1;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lb2/b1<",
            "TR;>;"
...
.method public constructor <init>()V
    ...
    invoke-direct {v0, v1}, Lb2/f;-><init>(Landroid/os/Looper;)V

    iput-object v0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zab:Lb2/f;
...
.method public constructor <init>(La2/q;)V
    ...
    .line 14
    invoke-virtual {p1}, La2/q;->d()Landroid/os/Looper;
    ...
    .line 15
    invoke-direct {v1, v0}, Lb2/f;-><init>(Landroid/os/Looper;)V

    iput-object v1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zab:Lb2/f;
...
.method public constructor <init>(Landroid/os/Looper;)V
    ...
    .line 9
    invoke-direct {v0, p1}, Lb2/f;-><init>(Landroid/os/Looper;)V
...
.method public constructor <init>(Lb2/f;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zab:Lb2/f;
...
.method private final zaa()La2/w;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()TR;"
    ...
    invoke-static {v1, v3}, Ld2/o;->k(ZLjava/lang/Object;)V
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zaj:La2/w;

    const/4 v3, 0x0

    iput-object v3, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zaj:La2/w;

    iput-object v3, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zah:La2/x;
...
.method private final zab(La2/w;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TR;)V"
    ...
    .line 1
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zaj:La2/w;
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zah:La2/x;

    goto :goto_0

    .line 3
    :cond_0
    iget-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zah:La2/x;

    if-nez p1, :cond_1

    iget-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zaj:La2/w;
    ...
    new-instance p1, Lb2/n1;

    invoke-direct {p1, p0}, Lb2/n1;-><init>(Lcom/google/android/gms/common/api/internal/BasePendingResult;)V

    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->mResultGuardian:Lb2/n1;

    goto :goto_0

    :cond_1
    iget-object v0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zab:Lb2/f;
    ...
    .line 6
    invoke-direct {p0}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zaa()La2/w;

    move-result-object v1

    invoke-virtual {v0, p1, v1}, Lb2/f;->a(La2/x;La2/w;)V
    ...
    .line 9
    invoke-interface {v2, v3}, La2/r;->a(Lcom/google/android/gms/common/api/Status;)V
...
.method public static bridge synthetic zaj(Lcom/google/android/gms/common/api/internal/BasePendingResult;)La2/w;
    .locals 0

    iget-object p0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zaj:La2/w;

    return-object p0
.end method

.method public static zal(La2/w;)V
    .locals 1
    ...
    invoke-interface {v0}, La2/u;->release()V
    :try_end_0
...
# virtual methods
.method public final addStatusListener(La2/r;)V
    .locals 2
    ...
    .line 3
    invoke-interface {p1, v1}, La2/r;->a(Lcom/google/android/gms/common/api/Status;)V
...
.method public final await()La2/w;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()TR;"
    ...
    .line 2
    invoke-static {v0, v2}, Ld2/o;->k(ZLjava/lang/Object;)V

    iget-object v0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zap:Lb2/b1;
    ...
    .line 3
    invoke-static {v1, v0}, Ld2/o;->k(ZLjava/lang/Object;)V
...
.method public final await(JLjava/util/concurrent/TimeUnit;)La2/w;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
...
.method public cancel()V
    ...
    .line 3
    invoke-static {v1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zal(La2/w;)V
    ...
    invoke-virtual {p0, v1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->createFailedResult(Lcom/google/android/gms/common/api/Status;)La2/w;

    move-result-object v1

    invoke-direct {p0, v1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zab(La2/w;)V
...
.method public abstract createFailedResult(Lcom/google/android/gms/common/api/Status;)La2/w;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final forceFailureUnlessReady(Lcom/google/android/gms/common/api/Status;)V
    ...
    .line 2
    invoke-virtual {p0, p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->createFailedResult(Lcom/google/android/gms/common/api/Status;)La2/w;
...
.method public final setResult(La2/w;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TR;)V"
    ...
    .line 4
    invoke-direct {p0, p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zab(La2/w;)V
    ...
    .line 6
    :cond_0
    invoke-static {p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zal(La2/w;)V
...
.method public final setResultCallback(La2/x;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zap:Lb2/b1;
    ...
    .line 3
    invoke-static {v2, v1}, Ld2/o;->k(ZLjava/lang/Object;)V
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zab:Lb2/f;
    ...
    invoke-virtual {v1, p1, v2}, Lb2/f;->a(La2/x;La2/w;)V
...
.method public final setResultCallback(La2/x;JLjava/util/concurrent/TimeUnit;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p2, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zab:Lb2/f;
    ...
    invoke-virtual {p2, p1, p3}, Lb2/f;->a(La2/x;La2/w;)V
    ...
    iget-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zab:Lb2/f;
...
.method public final then(La2/y;)La2/z;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<S::",
    ...
    :try_start_0
    iget-object v2, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zap:Lb2/b1;
    ...
    .line 2
    invoke-static {v2, v4}, Ld2/o;->k(ZLjava/lang/Object;)V

    iget-object v2, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zah:La2/x;
    ...
    const-string v4, "Cannot call then() if result was canceled."
    ...
    iget-object v4, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zac:Ljava/lang/ref/WeakReference;

    invoke-direct {v2, v4}, Lb2/b1;-><init>(Ljava/lang/ref/WeakReference;)V

    iput-object v2, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zap:Lb2/b1;

    iget-object v2, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zap:Lb2/b1;

    .line 6
    iget-object v4, v2, Lb2/b1;->d:Ljava/lang/Object;
    ...
    :try_start_1
    iget-object v5, v2, Lb2/b1;->a:La2/y;
    ...
    .line 7
    iput-object p1, v2, Lb2/b1;->a:La2/y;

    new-instance p1, Lb2/b1;

    iget-object v1, v2, Lb2/b1;->f:Ljava/lang/ref/WeakReference;

    .line 8
    invoke-direct {p1, v1}, Lb2/b1;-><init>(Ljava/lang/ref/WeakReference;)V

    iput-object p1, v2, Lb2/b1;->b:Lb2/b1;

    .line 9
    invoke-virtual {v2}, Lb2/b1;->b()V
    ...
    invoke-virtual {v1, v2, v3}, Lb2/f;->a(La2/x;La2/w;)V
    ...
    iput-object v1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zah:La2/x;
...
.method public final zan(Lb2/c1;)V
    .locals 1
