...
.method public static appendingSink(Ljava/io/File;)Lokio/Sink;
    ...
    invoke-static {v3, p0, v4}, Lio/sentry/instrumentation/file/n;->b(Ljava/io/FileOutputStream;Ljava/io/File;Z)Ljava/io/FileOutputStream;
...
.method private static sink(Ljava/io/OutputStream;Lokio/Timeout;)Lokio/Sink;
    ...
    .line 2
    new-instance v3, Lokio/Okio$1;

    invoke-direct {v3, p1, p0}, Lokio/Okio$1;-><init>(Lokio/Timeout;Ljava/io/OutputStream;)V
...
.method public static sink(Ljava/net/Socket;)Lokio/Sink;
    ...
    invoke-static {p0, v3}, Lokio/Okio;->sink(Ljava/io/OutputStream;Lokio/Timeout;)Lokio/Sink;

    move-result-object p0

    .line 8
    invoke-virtual {v3, p0}, Lokio/AsyncTimeout;->sink(Lokio/Sink;)Lokio/Sink;
...
.method public static source(Ljava/io/File;)Lokio/Source;
    ...
    invoke-static {v3, p0}, Lio/sentry/instrumentation/file/i;->a(Ljava/io/FileInputStream;Ljava/io/File;)Ljava/io/FileInputStream;
...
.method private static source(Ljava/io/InputStream;Lokio/Timeout;)Lokio/Source;
    ...
    .line 2
    new-instance v3, Lokio/Okio$2;

    invoke-direct {v3, p1, p0}, Lokio/Okio$2;-><init>(Lokio/Timeout;Ljava/io/InputStream;)V
...
.method public static source(Ljava/net/Socket;)Lokio/Source;
    ...
    invoke-static {p0, v3}, Lokio/Okio;->source(Ljava/io/InputStream;Lokio/Timeout;)Lokio/Source;

    move-result-object p0

    .line 12
    invoke-virtual {v3, p0}, Lokio/AsyncTimeout;->source(Lokio/Source;)Lokio/Source;
