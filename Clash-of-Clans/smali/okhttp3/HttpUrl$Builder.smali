...
.method private addPathSegments(Ljava/lang/String;Z)Lokhttp3/HttpUrl$Builder;
    ...
    invoke-static {p1, v6, v4, v5}, Lokhttp3/internal/Util;->delimiterOffset(Ljava/lang/String;IILjava/lang/String;)I
...
.method private push(Ljava/lang/String;IIZZ)V
    ...
    invoke-static/range {p3 .. p3}, Lokhttp3/HttpUrl$Builder;->u(I)[C
    ...
    .line 2
    invoke-direct {v9, v10}, Lokhttp3/HttpUrl$Builder;->isDot(Ljava/lang/String;)Z
    ...
    .line 3
    :cond_0
    invoke-direct {v9, v10}, Lokhttp3/HttpUrl$Builder;->isDotDot(Ljava/lang/String;)Z
    ...
    .line 4
    invoke-direct {v9}, Lokhttp3/HttpUrl$Builder;->pop()V

    return-void

    .line 5
    :cond_1
    iget-object v11, v9, Lokhttp3/HttpUrl$Builder;->encodedPathSegments:Ljava/util/List;
    ...
    invoke-interface {v11, p0, v10}, Ljava/util/List;->set(ILjava/lang/Object;)Ljava/lang/Object;
    ...
    .line 8
    iget-object v10, v9, Lokhttp3/HttpUrl$Builder;->encodedPathSegments:Ljava/util/List;
    ...
    invoke-static/range {p3 .. p3}, Lokhttp3/HttpUrl$Builder;->k(I)[C
...
.method private resolvePath(Ljava/lang/String;II)V
    ...
    invoke-static/range {p1 .. p1}, Lokhttp3/HttpUrl$Builder;->n(I)[C
    ...
    invoke-static/range {p1 .. p1}, Lokhttp3/HttpUrl$Builder;->f(I)[C
    ...
    .line 5
    invoke-static {v11, v6, p0, v12}, Lokhttp3/internal/Util;->delimiterOffset(Ljava/lang/String;IILjava/lang/String;)I
...
.method public addEncodedQueryParameter(Ljava/lang/String;Ljava/lang/String;)Lokhttp3/HttpUrl$Builder;
    ...
    iput-object v3, p0, Lokhttp3/HttpUrl$Builder;->encodedQueryNamesAndValues:Ljava/util/List;
...
.method public build()Lokhttp3/HttpUrl;
    ...
    .line 3
    new-instance v3, Lokhttp3/HttpUrl;

    invoke-direct {v3, p0}, Lokhttp3/HttpUrl;-><init>(Lokhttp3/HttpUrl$Builder;)V
...
.method public encodedPath(Ljava/lang/String;)Lokhttp3/HttpUrl$Builder;
    ...
    invoke-direct {p0, p1, v3, v4}, Lokhttp3/HttpUrl$Builder;->resolvePath(Ljava/lang/String;II)V
...
.method public host(Ljava/lang/String;)Lokhttp3/HttpUrl$Builder;
    ...
    invoke-static {p1, v3, v4}, Lokhttp3/HttpUrl$Builder;->canonicalizeHost(Ljava/lang/String;II)Ljava/lang/String;
...
.method public parse(Lokhttp3/HttpUrl;Ljava/lang/String;)Lokhttp3/HttpUrl$Builder;
    ...
    invoke-direct/range {v18 .. v19}, Lokhttp3/HttpUrl$Builder;->g(I)[C
    ...
    const v19, 0x2d3d4a1d

    const v18, -0x251b2d85
    ...
    invoke-direct/range {v18 .. v19}, Lokhttp3/HttpUrl$Builder;->h(I)[C
    ...
    const v19, 0x5594ab89

    const v18, -0x2190b1a7
    ...
    invoke-direct/range {v18 .. v19}, Lokhttp3/HttpUrl$Builder;->e(I)[C
    ...
    const v19, 0x2ae1a535

    const v18, -0x6fe712ca
    ...
    invoke-direct/range {v18 .. v19}, Lokhttp3/HttpUrl$Builder;->t(I)[C
    ...
    const v19, 0x6681870d

    const v18, -0x205a9cf9

    rsub-int/lit8 v19, v19, 0x24

    xor-int v19, v19, v18

    move-object/16 v18, p0

    invoke-direct/range {v18 .. v19}, Lokhttp3/HttpUrl$Builder;->q(I)[C
    ...
    const v19, 0x5a5cdf12

    const v18, -0x1f4b4e76
    ...
    invoke-direct/range {v18 .. v19}, Lokhttp3/HttpUrl$Builder;->j(I)[C
    ...
    :goto_2
    const v19, 0x5e09fbad

    const v18, -0x18c19608

    rsub-int/lit8 v19, v19, 0x33

    xor-int v19, v19, v18

    move-object/16 v18, p0

    invoke-direct/range {v18 .. v19}, Lokhttp3/HttpUrl$Builder;->d(I)[C
    ...
    :cond_7
    const v19, 0x61be2f06

    const v18, 0x324417d3

    sub-int v19, v19, v18

    add-int/lit8 v19, v19, 0x73

    move-object/16 v18, p0

    invoke-direct/range {v18 .. v19}, Lokhttp3/HttpUrl$Builder;->m(I)[C
    ...
    const v19, 0x1fea0411

    const v18, 0x1dd7bccf
    ...
    invoke-direct/range {v18 .. v19}, Lokhttp3/HttpUrl$Builder;->a(I)[C
    ...
    const v19, 0x1c40662b

    const v18, -0x3d444a44
    ...
    invoke-direct/range {v18 .. v19}, Lokhttp3/HttpUrl$Builder;->o(I)[C
    ...
    const v19, 0x54c3614f

    const v18, 0x5ef4208a
    ...
    invoke-direct/range {v18 .. v19}, Lokhttp3/HttpUrl$Builder;->l(I)[C
    ...
    const v19, 0x442316cf

    const v18, -0x2db00c91
    ...
    :cond_e
    :goto_8
    const v19, 0x2b329c9d

    const v18, -0x233ee00e

    add-int v19, v19, v18

    add-int/lit8 v19, v19, 0x63

    move-object/16 v18, p0

    invoke-direct/range {v18 .. v19}, Lokhttp3/HttpUrl$Builder;->p(I)[C
    ...
    const v19, 0x7386c616

    const v18, -0x3bef9e02
    ...
    invoke-direct/range {v18 .. v19}, Lokhttp3/HttpUrl$Builder;->b(I)[C
    ...
    const v19, 0x1e2e69c2

    const v18, -0x2bbaab0e
    ...
    invoke-direct/range {v18 .. v19}, Lokhttp3/HttpUrl$Builder;->c(I)[C
    ...
    invoke-direct/range {v18 .. v19}, Lokhttp3/HttpUrl$Builder;->i(I)[C
    ...
    invoke-direct/range {v18 .. v19}, Lokhttp3/HttpUrl$Builder;->r(I)[C
...
.method public port(I)Lokhttp3/HttpUrl$Builder;
    ...
    .line 3
    invoke-static {v4, p1}, Landroid/support/v4/media/b;->a(Ljava/lang/String;I)Ljava/lang/String;
...
.method public reencodeForUri()Lokhttp3/HttpUrl$Builder;
    ...
    .line 8
    iget-object v5, p0, Lokhttp3/HttpUrl$Builder;->encodedQueryNamesAndValues:Ljava/util/List;
    ...
    .line 12
    :cond_2
    iget-object v5, p0, Lokhttp3/HttpUrl$Builder;->encodedFragment:Ljava/lang/String;
    ...
    iput-object v3, p0, Lokhttp3/HttpUrl$Builder;->encodedFragment:Ljava/lang/String;
...
.method public scheme(Ljava/lang/String;)Lokhttp3/HttpUrl$Builder;
    ...
    .line 3
    iput-object v3, p0, Lokhttp3/HttpUrl$Builder;->scheme:Ljava/lang/String;
...
.method public setEncodedPathSegment(ILjava/lang/String;)Lokhttp3/HttpUrl$Builder;
    ...
    .line 5
    invoke-direct {p0, v3}, Lokhttp3/HttpUrl$Builder;->isDot(Ljava/lang/String;)Z

    move-result p1

    if-nez p1, :cond_0

    invoke-direct {p0, v3}, Lokhttp3/HttpUrl$Builder;->isDotDot(Ljava/lang/String;)Z
    ...
    .line 7
    invoke-static {v3, p2}, Lf/i;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public toString()Ljava/lang/String;
    ...
    :cond_5
    :goto_1
    iget v4, p0, Lokhttp3/HttpUrl$Builder;->port:I
    ...
    invoke-static {v6}, Lokhttp3/HttpUrl;->defaultPort(Ljava/lang/String;)I
    ...
    .line 27
    :cond_9
    iget-object v4, p0, Lokhttp3/HttpUrl$Builder;->encodedFragment:Ljava/lang/String;
