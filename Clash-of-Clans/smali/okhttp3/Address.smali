...
.method public constructor <init>(Ljava/lang/String;ILokhttp3/Dns;Ljavax/net/SocketFactory;Ljavax/net/ssl/SSLSocketFactory;Ljavax/net/ssl/HostnameVerifier;Lokhttp3/CertificatePinner;Lokhttp3/Authenticator;Ljava/net/Proxy;Ljava/util/List;Ljava/util/List;Ljava/net/ProxySelector;)V
    ...
    const p10, 0x53967f8a

    const p12, 0x26fac479

    sub-int p10, p10, p12

    add-int/lit8 p10, p10, -0x2c
    ...
    :cond_0
    const p10, 0x6481412b

    const p12, 0x3ae57724

    xor-int p10, p10, p12

    add-int/lit8 p10, p10, 0x63
    ...
    iput-object v3, v2, Lokhttp3/Address;->url:Lokhttp3/HttpUrl;

    const p10, 0x3351bda7

    const p12, -0x46dc3e4d

    sub-int p10, p10, p12

    add-int/lit8 p10, p10, 0x0
    ...
    .line 8
    iput-object p0, v2, Lokhttp3/Address;->dns:Lokhttp3/Dns;

    const p10, 0x2bda9339

    const p12, -0x2b403904

    add-int p10, p10, p12

    add-int/lit8 p10, p10, 0x10
    ...
    .line 10
    iput-object p1, v2, Lokhttp3/Address;->socketFactory:Ljavax/net/SocketFactory;

    const p10, 0x7087aa9e

    const p12, -0x48d22a38

    rsub-int/lit8 p10, p10, 0x2e
    ...
    .line 12
    iput-object p5, v2, Lokhttp3/Address;->proxyAuthenticator:Lokhttp3/Authenticator;

    const p10, 0x72bbb0b6

    const p12, -0x40502e7

    add-int p10, p10, p12

    add-int/lit8 p10, p10, 0x1e
    ...
    .line 13
    invoke-static {p7, v3}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;

    .line 14
    invoke-static {p7}, Lokhttp3/internal/Util;->immutableList(Ljava/util/List;)Ljava/util/List;

    move-result-object v3

    iput-object v3, v2, Lokhttp3/Address;->protocols:Ljava/util/List;

    const p10, 0x7d4e44df

    const p12, -0x1aa9e5e

    rsub-int/lit8 p10, p10, -0x4e
    ...
    .line 15
    invoke-static {p8, v3}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;

    .line 16
    invoke-static {p8}, Lokhttp3/internal/Util;->immutableList(Ljava/util/List;)Ljava/util/List;

    move-result-object v3

    iput-object v3, v2, Lokhttp3/Address;->connectionSpecs:Ljava/util/List;

    const p10, 0x4e0b86ba    # 5.8521562E8f

    const p12, -0x4739b3f6

    add-int p10, p10, p12

    add-int/lit8 p10, p10, -0x12
    ...
    .line 17
    invoke-static {p9, v3}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;

    .line 18
    iput-object p9, v2, Lokhttp3/Address;->proxySelector:Ljava/net/ProxySelector;

    .line 19
    iput-object p6, v2, Lokhttp3/Address;->proxy:Ljava/net/Proxy;

    .line 20
    iput-object p2, v2, Lokhttp3/Address;->sslSocketFactory:Ljavax/net/ssl/SSLSocketFactory;

    .line 21
    iput-object p3, v2, Lokhttp3/Address;->hostnameVerifier:Ljavax/net/ssl/HostnameVerifier;

    .line 22
    iput-object p4, v2, Lokhttp3/Address;->certificatePinner:Lokhttp3/CertificatePinner;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v4, p0, Lokhttp3/Address;->proxySelector:Ljava/net/ProxySelector;
