...
.method private connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    invoke-virtual {p4, p3, v4, v3}, Lokhttp3/EventListener;->connectStart(Lokhttp3/Call;Ljava/net/InetSocketAddress;Ljava/net/Proxy;)V
...
.method private connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    .line 5
    invoke-virtual {v4, v6, v7, v8, v9}, Ljavax/net/ssl/SSLSocketFactory;->createSocket(Ljava/net/Socket;Ljava/lang/String;IZ)Ljava/net/Socket;
    ...
    invoke-direct {v5, p1}, Ljavax/net/ssl/SSLPeerUnverifiedException;-><init>(Ljava/lang/String;)V
    ...
    .line 27
    invoke-virtual {v6, v3, v8}, Lokhttp3/CertificatePinner;->check(Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-virtual {p1, v4}, Lokhttp3/internal/platform/Platform;->getSelectedProtocol(Ljavax/net/ssl/SSLSocket;)Ljava/lang/String;
    ...
    invoke-virtual {v3, v5}, Lokhttp3/internal/platform/Platform;->afterHandshake(Ljavax/net/ssl/SSLSocket;)V
...
.method private createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    invoke-direct {v3, v6, v6, v4, v5}, Lokhttp3/internal/http1/Http1Codec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;Lokio/BufferedSource;Lokio/BufferedSink;)V
    ...
    invoke-virtual {v3, v4, p4}, Lokhttp3/internal/http1/Http1Codec;->writeRequest(Lokhttp3/Headers;Ljava/lang/String;)V
    ...
    .line 8
    invoke-virtual {v3, v4}, Lokhttp3/internal/http1/Http1Codec;->readResponseHeaders(Z)Lokhttp3/Response$Builder;
    ...
    .line 12
    :cond_0
    invoke-virtual {v3, v7, v8}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)Lokio/Source;
    ...
    .line 13
    invoke-static {v3, v4, v5}, Lokhttp3/internal/Util;->skipAll(Lokio/Source;ILjava/util/concurrent/TimeUnit;)Z
    ...
    invoke-interface {v3, v4, p3}, Lokhttp3/Authenticator;->authenticate(Lokhttp3/Route;Lokhttp3/Response;)Lokhttp3/Request;
    ...
    .line 17
    invoke-virtual {p3, v4}, Lokhttp3/Response;->header(Ljava/lang/String;)Ljava/lang/String;
...
.method public connect(IIIIZLokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    const v17, 0x4f86efd5

    const v16, -0x5c26ebe1

    rsub-int/lit8 v17, v17, -0x3e

    xor-int v17, v17, v16

    move-object/16 v16, p0

    invoke-direct/range {v16 .. v17}, Lokhttp3/internal/connection/RealConnection;->f(I)[C
    ...
    .line 9
    invoke-static {v3, v0, v4}, Landroid/support/v4/media/e;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const v17, 0x5c01d459

    const v16, -0x1d3809a3
    ...
    const v17, 0x1cb4bab0

    const v16, 0x4d6ddbf4    # 2.4941344E8f
    ...
    const v17, 0x45df3fca

    const v16, -0x6ed9f731

    rsub-int/lit8 v17, v17, -0x7f
    ...
    const v17, 0x514eba4a

    const v16, 0x2d13ec50
    ...
    invoke-direct/range {v16 .. v17}, Lokhttp3/internal/connection/RealConnection;->b(I)[C
