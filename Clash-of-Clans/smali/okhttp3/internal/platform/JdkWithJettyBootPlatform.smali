...
.method public static buildIfSupported()Lokhttp3/internal/platform/Platform;
    ...
    const v9, 0x4c229288    # 4.2617376E7f

    const v11, 0x12946138

    add-int v9, v9, v11

    add-int/lit8 v9, v9, -0x2c

    invoke-static/range {v9 .. v9}, Lokhttp3/internal/platform/JdkWithJettyBootPlatform;->c(I)[C
    ...
    const v11, -0x3ac6fa67

    rsub-int/lit8 v9, v9, -0x65

    xor-int v9, v9, v11

    invoke-static/range {v9 .. v9}, Lokhttp3/internal/platform/JdkWithJettyBootPlatform;->h(I)[C
    ...
    const v11, 0x36355942

    xor-int v9, v9, v11

    add-int/lit8 v9, v9, -0x3a

    invoke-static/range {v9 .. v9}, Lokhttp3/internal/platform/JdkWithJettyBootPlatform;->b(I)[C
    ...
    const v11, 0x1b54edfb

    add-int v9, v9, v11

    add-int/lit8 v9, v9, 0x4a

    invoke-static/range {v9 .. v9}, Lokhttp3/internal/platform/JdkWithJettyBootPlatform;->e(I)[C
...
.method public afterHandshake(Ljavax/net/ssl/SSLSocket;)V
    ...
    .line 1
    :try_start_0
    iget-object v3, p0, Lokhttp3/internal/platform/JdkWithJettyBootPlatform;->removeMethod:Ljava/lang/reflect/Method;
...
.method public configureTlsExtensions(Ljavax/net/ssl/SSLSocket;Ljava/lang/String;Ljava/util/List;)V
    ...
    iget-object v5, p0, Lokhttp3/internal/platform/JdkWithJettyBootPlatform;->clientProviderClass:Ljava/lang/Class;

    const/4 v6, 0x0

    aput-object v5, v4, v6

    iget-object v5, p0, Lokhttp3/internal/platform/JdkWithJettyBootPlatform;->serverProviderClass:Ljava/lang/Class;
    ...
    invoke-direct {v5, p2}, Lokhttp3/internal/platform/JdkWithJettyBootPlatform$JettyNegoProvider;-><init>(Ljava/util/List;)V

    invoke-static {p3, v4, v5}, Ljava/lang/reflect/Proxy;->newProxyInstance(Ljava/lang/ClassLoader;[Ljava/lang/Class;Ljava/lang/reflect/InvocationHandler;)Ljava/lang/Object;
...
.method public getSelectedProtocol(Ljavax/net/ssl/SSLSocket;)Ljava/lang/String;
    ...
    .line 3
    iget-boolean v4, v3, Lokhttp3/internal/platform/JdkWithJettyBootPlatform$JettyNegoProvider;->unsupported:Z

    if-nez v4, :cond_0

    iget-object v5, v3, Lokhttp3/internal/platform/JdkWithJettyBootPlatform$JettyNegoProvider;->selected:Ljava/lang/String;
    ...
    invoke-virtual {v3, v4, v5, p1}, Lokhttp3/internal/platform/Platform;->log(ILjava/lang/String;Ljava/lang/Throwable;)V
    ...
    .line 5
    :cond_1
    iget-object p1, v3, Lokhttp3/internal/platform/JdkWithJettyBootPlatform$JettyNegoProvider;->selected:Ljava/lang/String;
    :try_end_0
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Ljava/lang/IllegalAccessException; {:try_start_0 .. :try_end_0} :catch_0
