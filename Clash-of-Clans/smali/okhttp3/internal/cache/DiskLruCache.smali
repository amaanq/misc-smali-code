...
.method public constructor <init>(Lokhttp3/internal/io/FileSystem;Ljava/io/File;IIJLjava/util/concurrent/Executor;)V
    ...
    .line 2
    iput-wide v0, v6, Lokhttp3/internal/cache/DiskLruCache;->size:J
    ...
    iput-object v2, v6, Lokhttp3/internal/cache/DiskLruCache;->lruEntries:Ljava/util/LinkedHashMap;

    .line 4
    iput-wide v0, v6, Lokhttp3/internal/cache/DiskLruCache;->nextSequenceNumber:J

    .line 5
    new-instance v0, Lokhttp3/internal/cache/DiskLruCache$1;

    invoke-direct {v0, v6}, Lokhttp3/internal/cache/DiskLruCache$1;-><init>(Lokhttp3/internal/cache/DiskLruCache;)V

    iput-object v0, v6, Lokhttp3/internal/cache/DiskLruCache;->cleanupRunnable:Ljava/lang/Runnable;

    .line 6
    iput-object v7, v6, Lokhttp3/internal/cache/DiskLruCache;->fileSystem:Lokhttp3/internal/io/FileSystem;

    .line 7
    iput-object v8, v6, Lokhttp3/internal/cache/DiskLruCache;->directory:Ljava/io/File;

    .line 8
    iput p0, v6, Lokhttp3/internal/cache/DiskLruCache;->appVersion:I

    .line 9
    new-instance v7, Ljava/io/File;

    const p5, 0x741eebb7    # 5.0364E31f
    ...
    invoke-static/range {p5 .. p5}, Lokhttp3/internal/cache/DiskLruCache;->f(I)[C
    ...
    iput-object v7, v6, Lokhttp3/internal/cache/DiskLruCache;->journalFile:Ljava/io/File;
    ...
    invoke-static/range {p5 .. p5}, Lokhttp3/internal/cache/DiskLruCache;->d(I)[C
    ...
    iput-object v7, v6, Lokhttp3/internal/cache/DiskLruCache;->journalFileTmp:Ljava/io/File;
    ...
    invoke-static/range {p5 .. p5}, Lokhttp3/internal/cache/DiskLruCache;->g(I)[C
    ...
    iput-object v7, v6, Lokhttp3/internal/cache/DiskLruCache;->journalFileBackup:Ljava/io/File;

    .line 12
    iput p1, v6, Lokhttp3/internal/cache/DiskLruCache;->valueCount:I

    .line 13
    iput-wide p2, v6, Lokhttp3/internal/cache/DiskLruCache;->maxSize:J

    .line 14
    iput-object p4, v6, Lokhttp3/internal/cache/DiskLruCache;->executor:Ljava/util/concurrent/Executor;
...
.method public static create(Lokhttp3/internal/io/FileSystem;Ljava/io/File;IIJ)Lokhttp3/internal/cache/DiskLruCache;
    ...
    const p5, 0x4ad812df    # 7080303.5f

    xor-int p3, p3, p5

    add-int/lit8 p3, p3, -0x60

    invoke-static/range {p3 .. p3}, Lokhttp3/internal/cache/DiskLruCache;->b(I)[C
    ...
    invoke-static/range {p3 .. p3}, Lokhttp3/internal/cache/DiskLruCache;->c(I)[C
    ...
    invoke-static/range {p3 .. p3}, Lokhttp3/internal/cache/DiskLruCache;->e(I)[C
...
.method private readJournal()V
    ...
    invoke-direct/range {v0 .. v1}, Lokhttp3/internal/cache/DiskLruCache;->h(I)[C
    ...
    invoke-direct {p0, v5}, Lokhttp3/internal/cache/DiskLruCache;->readJournalLine(Ljava/lang/String;)V
    :try_end_1
...
.method private readJournalLine(Ljava/lang/String;)V
    ...
    invoke-direct {v8, p0, v7}, Lokhttp3/internal/cache/DiskLruCache$Entry;-><init>(Lokhttp3/internal/cache/DiskLruCache;Ljava/lang/String;)V
    ...
    .line 12
    iput-boolean v4, v8, Lokhttp3/internal/cache/DiskLruCache$Entry;->readable:Z

    const/4 v3, 0x0

    .line 13
    iput-object v3, v8, Lokhttp3/internal/cache/DiskLruCache$Entry;->currentEditor:Lokhttp3/internal/cache/DiskLruCache$Editor;

    .line 14
    invoke-virtual {v8, p1}, Lokhttp3/internal/cache/DiskLruCache$Entry;->setLengths([Ljava/lang/String;)V
...
.method private validateKey(Ljava/lang/String;)V
    ...
    .line 4
    invoke-static {v4, p1, v5}, Landroid/support/v4/media/e;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public declared-synchronized completeEdit(Lokhttp3/internal/cache/DiskLruCache$Editor;Z)V
    ...
    .line 3
    iget-boolean v5, v3, Lokhttp3/internal/cache/DiskLruCache$Entry;->readable:Z
    ...
    .line 5
    iget-object v6, p1, Lokhttp3/internal/cache/DiskLruCache$Editor;->written:[Z
    ...
    iget-object v7, v3, Lokhttp3/internal/cache/DiskLruCache$Entry;->dirtyFiles:[Ljava/io/File;

    aget-object v7, v7, v5

    invoke-interface {v6, v7}, Lokhttp3/internal/io/FileSystem;->exists(Ljava/io/File;)Z
    ...
    .line 12
    iget-object p1, v3, Lokhttp3/internal/cache/DiskLruCache$Entry;->dirtyFiles:[Ljava/io/File;
    ...
    invoke-interface {v5, p1}, Lokhttp3/internal/io/FileSystem;->exists(Ljava/io/File;)Z
    ...
    invoke-interface {v6, p1, v5}, Lokhttp3/internal/io/FileSystem;->rename(Ljava/io/File;Ljava/io/File;)V

    .line 16
    iget-object p1, v3, Lokhttp3/internal/cache/DiskLruCache$Entry;->lengths:[J
    ...
    invoke-interface {p1, v5}, Lokhttp3/internal/io/FileSystem;->size(Ljava/io/File;)J
    ...
    invoke-interface {v5, p1}, Lokhttp3/internal/io/FileSystem;->delete(Ljava/io/File;)V
    ...
    .line 22
    iput-object p1, v3, Lokhttp3/internal/cache/DiskLruCache$Entry;->currentEditor:Lokhttp3/internal/cache/DiskLruCache$Editor;

    .line 23
    iget-boolean p1, v3, Lokhttp3/internal/cache/DiskLruCache$Entry;->readable:Z
    ...
    .line 24
    iput-boolean v4, v3, Lokhttp3/internal/cache/DiskLruCache$Entry;->readable:Z
    ...
    invoke-virtual {v3, p1}, Lokhttp3/internal/cache/DiskLruCache$Entry;->writeLengths(Lokio/BufferedSink;)V
    ...
    iput-wide p1, v3, Lokhttp3/internal/cache/DiskLruCache$Entry;->sequenceNumber:J
    ...
    iget-object p2, v3, Lokhttp3/internal/cache/DiskLruCache$Entry;->key:Ljava/lang/String;
...
.method public declared-synchronized edit(Ljava/lang/String;J)Lokhttp3/internal/cache/DiskLruCache$Editor;
    ...
    .line 6
    iget-wide v4, v3, Lokhttp3/internal/cache/DiskLruCache$Entry;->sequenceNumber:J
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 8
    :try_start_1
    iget-object p2, v3, Lokhttp3/internal/cache/DiskLruCache$Entry;->currentEditor:Lokhttp3/internal/cache/DiskLruCache$Editor;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public declared-synchronized get(Ljava/lang/String;)Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    .line 6
    :cond_0
    invoke-virtual {v3}, Lokhttp3/internal/cache/DiskLruCache$Entry;->snapshot()Lokhttp3/internal/cache/DiskLruCache$Snapshot;
...
.method public declared-synchronized initialize()V
    ...
    invoke-interface {v3, v4, v5}, Lokhttp3/internal/io/FileSystem;->rename(Ljava/io/File;Ljava/io/File;)V
    ...
    iget-object v8, p0, Lokhttp3/internal/cache/DiskLruCache;->directory:Ljava/io/File;
    ...
    .line 14
    invoke-virtual {v5, v6, v7, v3}, Lokhttp3/internal/platform/Platform;->log(ILjava/lang/String;Ljava/lang/Throwable;)V
    :try_end_3
...
.method public declared-synchronized rebuildJournal()V
    ...
    invoke-interface {v3, v4}, Lokhttp3/internal/io/FileSystem;->sink(Ljava/io/File;)Lokio/Sink;
    ...
    invoke-direct/range {v0 .. v1}, Lokhttp3/internal/cache/DiskLruCache;->a(I)[C
    ...
    .line 10
    iget-object v7, v6, Lokhttp3/internal/cache/DiskLruCache$Entry;->currentEditor:Lokhttp3/internal/cache/DiskLruCache$Editor;
    ...
    .line 15
    iget-object v7, v6, Lokhttp3/internal/cache/DiskLruCache$Entry;->key:Ljava/lang/String;

    invoke-interface {v3, v7}, Lokio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lokio/BufferedSink;

    .line 16
    invoke-virtual {v6, v3}, Lokhttp3/internal/cache/DiskLruCache$Entry;->writeLengths(Lokio/BufferedSink;)V
    ...
    .line 24
    iput-boolean v3, p0, Lokhttp3/internal/cache/DiskLruCache;->hasJournalErrors:Z

    .line 25
    iput-boolean v3, p0, Lokhttp3/internal/cache/DiskLruCache;->mostRecentRebuildFailed:Z
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_1
...
.method public removeEntry(Lokhttp3/internal/cache/DiskLruCache$Entry;)Z
    ...
    .line 1
    iget-object v3, p1, Lokhttp3/internal/cache/DiskLruCache$Entry;->currentEditor:Lokhttp3/internal/cache/DiskLruCache$Editor;
    ...
    iget-object v5, p1, Lokhttp3/internal/cache/DiskLruCache$Entry;->cleanFiles:[Ljava/io/File;
    ...
    iget-object v6, p1, Lokhttp3/internal/cache/DiskLruCache$Entry;->lengths:[J
    ...
    iget-object v5, p1, Lokhttp3/internal/cache/DiskLruCache$Entry;->key:Ljava/lang/String;
