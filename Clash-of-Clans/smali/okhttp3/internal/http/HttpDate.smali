...
.method public static constructor <clinit>()V
    ...
    const v16, 0x27b12fba

    const v18, 0x231c7e41

    xor-int v16, v16, v18

    add-int/lit8 v16, v16, -0x16

    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http/HttpDate;->a(I)[C
    ...
    const v16, 0x3f05ef3f

    const v18, 0x15a4ec89

    xor-int v16, v16, v18

    add-int/lit8 v16, v16, -0x18

    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http/HttpDate;->d(I)[C
    ...
    const v18, -0x751cb3b3

    rsub-int/lit8 v16, v16, 0x61

    xor-int v16, v16, v18

    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http/HttpDate;->l(I)[C
    ...
    const v16, 0x6a8da2bc

    const v18, 0x1c1b2c26

    xor-int v16, v16, v18

    add-int/lit8 v16, v16, 0x19

    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http/HttpDate;->o(I)[C
    ...
    const v18, 0x2e55af8d

    xor-int v16, v16, v18

    add-int/lit8 v16, v16, 0x2

    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http/HttpDate;->c(I)[C
    ...
    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http/HttpDate;->i(I)[C
    ...
    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http/HttpDate;->k(I)[C
    ...
    const v16, 0x43e86f00

    const v18, -0x1bb7551d    # -1.480665E22f

    add-int v16, v16, v18

    add-int/lit8 v16, v16, -0x5c

    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http/HttpDate;->j(I)[C
    ...
    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http/HttpDate;->b(I)[C
    ...
    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http/HttpDate;->h(I)[C
    ...
    const v18, 0x63c35b01

    xor-int v16, v16, v18

    add-int/lit8 v16, v16, 0x6a

    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http/HttpDate;->g(I)[C
    ...
    const v16, 0x11da8897

    const v18, 0x48e394e6

    add-int v16, v16, v18

    add-int/lit8 v16, v16, -0x3a

    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http/HttpDate;->e(I)[C
    ...
    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http/HttpDate;->n(I)[C
    ...
    const v16, 0x60df0b2c

    const v18, -0x5d783768

    add-int v16, v16, v18

    add-int/lit8 v16, v16, -0x66

    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http/HttpDate;->f(I)[C
    ...
    const v16, 0x1c05ea66

    const v18, 0x12061253

    xor-int v16, v16, v18

    add-int/lit8 v16, v16, 0x52

    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http/HttpDate;->m(I)[C
