...
.method public proceed(Lokhttp3/Request;Lokhttp3/internal/connection/StreamAllocation;Lokhttp3/internal/http/HttpCodec;Lokhttp3/internal/connection/RealConnection;)Lokhttp3/Response;
    ...
    const v18, 0x579190e8

    const v17, -0x530d0f8b
    ...
    invoke-direct/range {v17 .. v18}, Lokhttp3/internal/http/RealInterceptorChain;->i(I)[C
    ...
    const v18, 0x2ee3ab8e

    const v17, 0x7b01622c
    ...
    invoke-direct/range {v17 .. v18}, Lokhttp3/internal/http/RealInterceptorChain;->a(I)[C
    ...
    const v18, 0x1468c654

    const v17, 0x1298873d
    ...
    invoke-direct/range {v17 .. v18}, Lokhttp3/internal/http/RealInterceptorChain;->g(I)[C
    ...
    :cond_5
    :goto_2
    const v18, 0x124f0017

    const v17, -0x358b9d96    # -4003994.5f
    ...
    invoke-direct/range {v17 .. v18}, Lokhttp3/internal/http/RealInterceptorChain;->c(I)[C
    ...
    invoke-direct/range {v17 .. v18}, Lokhttp3/internal/http/RealInterceptorChain;->f(I)[C
    ...
    const v18, 0x284361a3

    const v17, 0x66955053
    ...
    invoke-direct/range {v17 .. v18}, Lokhttp3/internal/http/RealInterceptorChain;->h(I)[C
...
.method public withConnectTimeout(ILjava/util/concurrent/TimeUnit;)Lokhttp3/Interceptor$Chain;
    ...
    const v17, 0x32ebf3a5

    const v16, 0x1047f864
    ...
    invoke-direct/range {v16 .. v17}, Lokhttp3/internal/http/RealInterceptorChain;->b(I)[C
...
.method public withReadTimeout(ILjava/util/concurrent/TimeUnit;)Lokhttp3/Interceptor$Chain;
    ...
    const v17, 0x6fa838e0

    const v16, 0x6242ec4f
    ...
    invoke-direct/range {v16 .. v17}, Lokhttp3/internal/http/RealInterceptorChain;->e(I)[C
...
.method public withWriteTimeout(ILjava/util/concurrent/TimeUnit;)Lokhttp3/Interceptor$Chain;
    ...
    const v17, 0x6ebd0f77

    const v16, -0x2805975b

    rsub-int/lit8 v17, v17, 0x63

    xor-int v17, v17, v16

    move-object/16 v16, p0

    invoke-direct/range {v16 .. v17}, Lokhttp3/internal/http/RealInterceptorChain;->d(I)[C
