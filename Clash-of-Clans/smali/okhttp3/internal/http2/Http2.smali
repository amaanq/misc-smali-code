...
.method public static constructor <clinit>()V
    ...
    const v16, 0x27c354da

    const v18, 0x4f28b6b9    # 2.8305472E9f

    add-int v16, v16, v18

    add-int/lit8 v16, v16, 0x71

    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http2/Http2;->j(I)[C
    ...
    const v18, 0x288d3256

    xor-int v16, v16, v18

    add-int/lit8 v16, v16, 0x5b

    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http2/Http2;->b(I)[C
    ...
    const v16, 0x1b8926e8

    const v18, 0x6da09ca8

    xor-int v16, v16, v18

    add-int/lit8 v16, v16, 0x6c

    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http2/Http2;->g(I)[C
    ...
    const v16, 0x4cb5ee4f    # 9.5384184E7f

    const v18, 0x197f4604

    sub-int v16, v16, v18

    add-int/lit8 v16, v16, -0x71

    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http2/Http2;->h(I)[C
    ...
    const v16, 0x2c5e41db

    const v18, -0x2086908d

    rsub-int/lit8 v16, v16, 0x48

    xor-int v16, v16, v18

    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http2/Http2;->r(I)[C
    ...
    const v16, 0x35e84cd2

    const v18, -0x2f38709d

    add-int v16, v16, v18

    add-int/lit8 v16, v16, 0x11

    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http2/Http2;->l(I)[C
    ...
    const v16, 0x6e4db1b3

    const v18, -0x2429e6ae

    add-int v16, v16, v18

    add-int/lit8 v16, v16, 0x4b

    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http2/Http2;->i(I)[C
    ...
    const v18, 0x5776dfff

    add-int v16, v16, v18

    add-int/lit8 v16, v16, 0x6b

    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http2/Http2;->f(I)[C
    ...
    const v16, 0x2aa9a974

    const v18, 0x455287d4

    xor-int v16, v16, v18

    add-int/lit8 v16, v16, -0x5c

    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http2/Http2;->e(I)[C
    ...
    const v16, 0x2f047236

    const v18, -0x36828a80

    sub-int v16, v16, v18

    add-int/lit8 v16, v16, -0x48

    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http2/Http2;->o(I)[C
    ...
    const v16, 0x4095e4c9

    const v18, 0x3ef99838

    sub-int v16, v16, v18

    add-int/lit8 v16, v16, -0xa

    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http2/Http2;->d(I)[C
    ...
    const v16, 0x7ee41178

    const v18, 0x323f1c85

    xor-int v16, v16, v18

    add-int/lit8 v16, v16, -0x67

    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http2/Http2;->k(I)[C
    ...
    const v16, 0x50e40e21

    const v18, -0x1f1244fb

    sub-int v16, v16, v18

    add-int/lit8 v16, v16, -0x1b

    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http2/Http2;->s(I)[C
    ...
    const v16, 0x4fdd5c8c

    const v18, 0x1c33538c

    add-int v16, v16, v18

    add-int/lit8 v16, v16, 0x42

    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http2/Http2;->m(I)[C
    ...
    const v16, 0x3d2fca78

    const v18, 0x42ec0e27

    xor-int v16, v16, v18

    add-int/lit8 v16, v16, -0x42

    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http2/Http2;->c(I)[C
    ...
    :goto_1
    const v16, 0x6f1cb0e1

    const v18, 0x599d9518

    sub-int v16, v16, v18

    add-int/lit8 v16, v16, -0x6e

    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http2/Http2;->n(I)[C
    ...
    const v16, 0x69b1d1cf

    const v18, -0x390ca953

    add-int v16, v16, v18

    add-int/lit8 v16, v16, -0x2c

    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http2/Http2;->a(I)[C
    ...
    const v16, 0x6fa00379

    const v18, 0x42253aea

    sub-int v16, v16, v18

    add-int/lit8 v16, v16, 0x50

    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http2/Http2;->p(I)[C
    ...
    const v16, 0x785fdc29

    const v18, 0x14a0eb59

    xor-int v16, v16, v18

    add-int/lit8 v16, v16, 0x34

    invoke-static/range {v16 .. v16}, Lokhttp3/internal/http2/Http2;->q(I)[C
