...
.method public declared-synchronized applyAndAckSettings(Lokhttp3/internal/http2/Settings;)V
    ...
    invoke-virtual {v3, p1}, Lokhttp3/internal/http2/Hpack$Writer;->setHeaderTableSizeSetting(I)V
...
.method public declared-synchronized data(ZILokio/Buffer;I)V
    ...
    .line 2
    :cond_0
    invoke-virtual {p0, p2, v3, p3, p4}, Lokhttp3/internal/http2/Http2Writer;->dataFrame(IBLokio/Buffer;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public frameHeader(IIBB)V
    ...
    invoke-static {v5, p1, p2, p3, p4}, Lokhttp3/internal/http2/Http2;->frameLog(ZIIBB)Ljava/lang/String;
    ...
    invoke-static {v3, p2}, Lokhttp3/internal/http2/Http2Writer;->writeMedium(Lokio/BufferedSink;I)V
...
.method public declared-synchronized goAway(ILokhttp3/internal/http2/ErrorCode;[B)V
    ...
    .line 4
    invoke-virtual {p0, v5, v3, v4, v5}, Lokhttp3/internal/http2/Http2Writer;->frameHeader(IIBB)V
...
.method public declared-synchronized headers(ILjava/util/List;)V
    ...
    .line 2
    invoke-virtual {p0, v3, p1, p2}, Lokhttp3/internal/http2/Http2Writer;->headers(ZILjava/util/List;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public headers(ZILjava/util/List;)V
    ...
    .line 9
    invoke-virtual {p0, p2, p3, p1, v8}, Lokhttp3/internal/http2/Http2Writer;->frameHeader(IIBB)V
    ...
    invoke-interface {p1, p3, v5, v6}, Lokio/Sink;->write(Lokio/Buffer;J)V
...
.method public declared-synchronized ping(ZII)V
    ...
    .line 2
    :goto_0
    invoke-virtual {p0, v5, v3, v4, p1}, Lokhttp3/internal/http2/Http2Writer;->frameHeader(IIBB)V
...
.method public declared-synchronized pushPromise(IILjava/util/List;)V
    ...
    .line 5
    invoke-virtual {p0, p1, p3, v6, v10}, Lokhttp3/internal/http2/Http2Writer;->frameHeader(IIBB)V
    ...
    invoke-interface {p2, p3, v7, v8}, Lokio/Sink;->write(Lokio/Buffer;J)V
...
.method public declared-synchronized rstStream(ILokhttp3/internal/http2/ErrorCode;)V
    ...
    .line 3
    invoke-virtual {p0, p1, v3, v4, v5}, Lokhttp3/internal/http2/Http2Writer;->frameHeader(IIBB)V
...
.method public declared-synchronized settings(Lokhttp3/internal/http2/Settings;)V
    ...
    .line 3
    invoke-virtual {p0, v4, v3, v5, v4}, Lokhttp3/internal/http2/Http2Writer;->frameHeader(IIBB)V
    ...
    invoke-interface {v6, v3}, Lokio/BufferedSink;->writeShort(I)Lokio/BufferedSink;
    ...
    invoke-interface {v3, v6}, Lokio/BufferedSink;->writeInt(I)Lokio/BufferedSink;
...
.method public declared-synchronized windowUpdate(IJ)V
    ...
    .line 7
    invoke-static {p1, v3}, Lokhttp3/internal/http2/Http2;->illegalArgument(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/IllegalArgumentException;
