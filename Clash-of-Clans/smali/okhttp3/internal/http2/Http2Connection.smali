...
.method public constructor <init>(Lokhttp3/internal/http2/Http2Connection$Builder;)V
    ...
    const v24, 0x53a72773

    const v26, 0x4d703e06    # 2.51912288E8f

    sub-int v24, v24, v26

    add-int/lit8 v24, v24, -0x76

    invoke-static/range {v24 .. v24}, Lokhttp3/internal/http2/Http2Connection;->a(I)[C
    ...
    invoke-static/range {v24 .. v24}, Lokhttp3/internal/http2/Http2Connection;->c(I)[C
...
.method private newStream(ILjava/util/List;Z)Lokhttp3/internal/http2/Http2Stream;
    ...
    .line 2
    iget-object v7, v10, Lokhttp3/internal/http2/Http2Connection;->writer:Lokhttp3/internal/http2/Http2Writer;
    ...
    .line 4
    :try_start_1
    iget v0, v10, Lokhttp3/internal/http2/Http2Connection;->nextStreamId:I
    ...
    invoke-virtual {v10, v0}, Lokhttp3/internal/http2/Http2Connection;->shutdown(Lokhttp3/internal/http2/ErrorCode;)V

    .line 6
    :cond_0
    iget-boolean v0, v10, Lokhttp3/internal/http2/Http2Connection;->shutdown:Z

    if-nez v0, :cond_7

    .line 7
    iget v8, v10, Lokhttp3/internal/http2/Http2Connection;->nextStreamId:I

    add-int/lit8 v0, v8, 0x2

    .line 8
    iput v0, v10, Lokhttp3/internal/http2/Http2Connection;->nextStreamId:I
    ...
    .line 10
    iget-wide v0, v10, Lokhttp3/internal/http2/Http2Connection;->bytesLeftInWriteWindow:J
    ...
    .line 12
    iget-object v0, v10, Lokhttp3/internal/http2/Http2Connection;->streams:Ljava/util/Map;
    ...
    .line 14
    :try_start_2
    iget-object v0, v10, Lokhttp3/internal/http2/Http2Connection;->writer:Lokhttp3/internal/http2/Http2Writer;

    invoke-virtual {v0, v6, v8, v11, v12}, Lokhttp3/internal/http2/Http2Writer;->synStream(ZIILjava/util/List;)V

    goto :goto_2

    .line 15
    :cond_4
    iget-boolean v0, v10, Lokhttp3/internal/http2/Http2Connection;->client:Z
    ...
    invoke-virtual {v0, v11, v8, v12}, Lokhttp3/internal/http2/Http2Writer;->pushPromise(IILjava/util/List;)V
    ...
    .line 18
    iget-object v11, v10, Lokhttp3/internal/http2/Http2Connection;->writer:Lokhttp3/internal/http2/Http2Writer;

    invoke-virtual {v11}, Lokhttp3/internal/http2/Http2Writer;->flush()V
    ...
    invoke-static/range {p1 .. p1}, Lokhttp3/internal/http2/Http2Connection;->d(I)[C
    ...
    :cond_7
    :try_start_4
    new-instance v11, Lokhttp3/internal/http2/ConnectionShutdownException;

    invoke-direct {v11}, Lokhttp3/internal/http2/ConnectionShutdownException;-><init>()V
...
.method public pushDataLater(ILokio/BufferedSource;IZ)V
    ...
    .line 2
    invoke-interface {p2, v3, v4}, Lokio/BufferedSource;->require(J)V

    .line 3
    invoke-interface {p2, v8, v3, v4}, Lokio/Source;->read(Lokio/Buffer;J)J
    ...
    invoke-direct/range {v3 .. v10}, Lokhttp3/internal/http2/Http2Connection$6;-><init>(Lokhttp3/internal/http2/Http2Connection;Ljava/lang/String;[Ljava/lang/Object;ILokio/Buffer;IZ)V
...
.method public pushHeadersLater(ILjava/util/List;Z)V
    ...
    invoke-direct/range {v3 .. v9}, Lokhttp3/internal/http2/Http2Connection$5;-><init>(Lokhttp3/internal/http2/Http2Connection;Ljava/lang/String;[Ljava/lang/Object;ILjava/util/List;Z)V

    invoke-direct {p0, v10}, Lokhttp3/internal/http2/Http2Connection;->pushExecutorExecute(Lokhttp3/internal/NamedRunnable;)V
    :try_end_0
...
.method public pushRequestLater(ILjava/util/List;)V
    ...
    .line 7
    :try_start_1
    new-instance v3, Lokhttp3/internal/http2/Http2Connection$4;
    ...
    invoke-direct/range {v5 .. v10}, Lokhttp3/internal/http2/Http2Connection$4;-><init>(Lokhttp3/internal/http2/Http2Connection;Ljava/lang/String;[Ljava/lang/Object;ILjava/util/List;)V

    invoke-direct {p0, v3}, Lokhttp3/internal/http2/Http2Connection;->pushExecutorExecute(Lokhttp3/internal/NamedRunnable;)V
    :try_end_1
...
.method public pushResetLater(ILokhttp3/internal/http2/ErrorCode;)V
    ...
    new-instance v9, Lokhttp3/internal/http2/Http2Connection$7;
    ...
    invoke-direct/range {v3 .. v8}, Lokhttp3/internal/http2/Http2Connection$7;-><init>(Lokhttp3/internal/http2/Http2Connection;Ljava/lang/String;[Ljava/lang/Object;ILokhttp3/internal/http2/ErrorCode;)V
...
.method public sendDegradedPingLater()V
    ...
    .line 6
    :try_start_1
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Connection;->writerExecutor:Ljava/util/concurrent/ScheduledExecutorService;

    new-instance v4, Lokhttp3/internal/http2/Http2Connection$3;
    ...
    iget-object v8, p0, Lokhttp3/internal/http2/Http2Connection;->hostname:Ljava/lang/String;

    aput-object v8, v6, v7

    invoke-direct {v4, p0, v5, v6}, Lokhttp3/internal/http2/Http2Connection$3;-><init>(Lokhttp3/internal/http2/Http2Connection;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public writeData(IZLokio/Buffer;J)V
    ...
    invoke-virtual {p1, v10, v9, p0, v0}, Lokhttp3/internal/http2/Http2Writer;->data(ZILokio/Buffer;I)V
    ...
    :goto_1
    :try_start_0
    iget-wide v3, v8, Lokhttp3/internal/http2/Http2Connection;->bytesLeftInWriteWindow:J
    ...
    .line 4
    iget-object v3, v8, Lokhttp3/internal/http2/Http2Connection;->streams:Ljava/util/Map;
    ...
    .line 8
    iget-object v3, v8, Lokhttp3/internal/http2/Http2Connection;->writer:Lokhttp3/internal/http2/Http2Writer;
    ...
    :goto_2
    invoke-virtual {v4, v5, v9, p0, v3}, Lokhttp3/internal/http2/Http2Writer;->data(ZILokio/Buffer;I)V
...
.method public writeSynResetLater(ILokhttp3/internal/http2/ErrorCode;)V
    ...
    new-instance v10, Lokhttp3/internal/http2/Http2Connection$1;
    ...
    invoke-direct/range {v4 .. v9}, Lokhttp3/internal/http2/Http2Connection$1;-><init>(Lokhttp3/internal/http2/Http2Connection;Ljava/lang/String;[Ljava/lang/Object;ILokhttp3/internal/http2/ErrorCode;)V
...
.method public writeWindowUpdateLater(IJ)V
    ...
    new-instance v11, Lokhttp3/internal/http2/Http2Connection$2;
    ...
    invoke-direct/range {v4 .. v10}, Lokhttp3/internal/http2/Http2Connection$2;-><init>(Lokhttp3/internal/http2/Http2Connection;Ljava/lang/String;[Ljava/lang/Object;IJ)V
