...
.method public static parse(Lokhttp3/Headers;)Lokhttp3/CacheControl;
    ...
    const v22, 0x7b1f3f05

    const v24, -0x586772fb

    add-int v22, v22, v24

    add-int/lit8 v22, v22, 0x1b

    invoke-static/range {v22 .. v22}, Lokhttp3/CacheControl;->o(I)[C
    ...
    const v24, 0x67bb5094

    add-int v22, v22, v24

    add-int/lit8 v22, v22, -0x32

    invoke-static/range {v22 .. v22}, Lokhttp3/CacheControl;->g(I)[C
    ...
    const v22, 0x22c49040

    const v24, 0x3f44150b

    add-int v22, v22, v24

    add-int/lit8 v22, v22, 0x15

    invoke-static/range {v22 .. v22}, Lokhttp3/CacheControl;->d(I)[C
    ...
    const v24, 0x393674c4

    add-int v22, v22, v24

    add-int/lit8 v22, v22, 0x21

    invoke-static/range {v22 .. v22}, Lokhttp3/CacheControl;->f(I)[C
    ...
    const v22, 0x25e021ee

    const v24, 0x17a7fa3c

    xor-int v22, v22, v24

    add-int/lit8 v22, v22, 0xb

    invoke-static/range {v22 .. v22}, Lokhttp3/CacheControl;->b(I)[C
    ...
    :goto_5
    const v22, 0x5a063bf5

    const v24, -0x11a36728

    sub-int v22, v22, v24

    add-int/lit8 v22, v22, 0x4

    invoke-static/range {v22 .. v22}, Lokhttp3/CacheControl;->e(I)[C
    ...
    :cond_5
    const v22, 0x3e4d3f45

    const v24, 0x1a4da3c7

    xor-int v22, v22, v24

    add-int/lit8 v22, v22, -0x4

    invoke-static/range {v22 .. v22}, Lokhttp3/CacheControl;->m(I)[C
    ...
    :cond_6
    const v22, 0x401291d3

    const v24, 0x256eff0d

    sub-int v22, v22, v24

    add-int/lit8 v22, v22, 0x1c

    invoke-static/range {v22 .. v22}, Lokhttp3/CacheControl;->c(I)[C
    ...
    :cond_7
    const v22, 0x15054fa2

    const v24, -0x304a839b

    sub-int v22, v22, v24

    add-int/lit8 v22, v22, 0x2f

    invoke-static/range {v22 .. v22}, Lokhttp3/CacheControl;->a(I)[C
    ...
    :cond_8
    const v22, 0x689111c7

    const v24, 0x1a0116f3

    sub-int v22, v22, v24

    add-int/lit8 v22, v22, -0x54

    invoke-static/range {v22 .. v22}, Lokhttp3/CacheControl;->q(I)[C
    ...
    :cond_9
    const v22, 0x31437c10

    const v24, -0x44d57e2b

    rsub-int/lit8 v22, v22, 0x45

    xor-int v22, v22, v24

    invoke-static/range {v22 .. v22}, Lokhttp3/CacheControl;->k(I)[C
    ...
    const v24, -0x73be6e2c

    sub-int v22, v22, v24

    add-int/lit8 v22, v22, -0x51

    invoke-static/range {v22 .. v22}, Lokhttp3/CacheControl;->n(I)[C
    ...
    :cond_b
    const v22, 0x22cd6e85

    const v24, -0x10e894a2

    rsub-int/lit8 v22, v22, 0x2e

    xor-int v22, v22, v24

    invoke-static/range {v22 .. v22}, Lokhttp3/CacheControl;->i(I)[C
    ...
    :cond_c
    const v22, 0x6261457b

    const v24, 0x652be003

    xor-int v22, v22, v24

    add-int/lit8 v22, v22, -0x73

    invoke-static/range {v22 .. v22}, Lokhttp3/CacheControl;->p(I)[C
    ...
    rsub-int/lit8 v22, v22, 0x11

    xor-int v22, v22, v24

    invoke-static/range {v22 .. v22}, Lokhttp3/CacheControl;->h(I)[C
    ...
    :cond_e
    const v22, 0x4648e732

    const v24, 0xb8e81b2

    xor-int v22, v22, v24

    add-int/lit8 v22, v22, 0x4e

    invoke-static/range {v22 .. v22}, Lokhttp3/CacheControl;->l(I)[C
    ...
    :cond_f
    const v22, 0x284b6a27

    const v24, -0x2b37bd1e

    rsub-int/lit8 v22, v22, -0x27

    xor-int v22, v22, v24

    invoke-static/range {v22 .. v22}, Lokhttp3/CacheControl;->j(I)[C
